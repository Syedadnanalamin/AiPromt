...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setServerError(err?.message || "Failed to initialize Google login.");
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Sign in to access your saved prompts & creator dashboard
          </p>
        </div>
        ...
        <Card className="glass-card border-border/70 bg-card/80 backdrop-blur-xl shadow-xl shadow-primary/5">
          <CardHeader className="space-y-1 pb-4">
            <CardTitle className="text-lg font-semibold text-center">
              Sign in to <span className="ai-gradient-text">PromptMatrix</span>
            </CardTitle>
            <CardDescription className="text-center text-xs">
              Enter your credentials or use social sign-in
            </CardDescription>
          </CardHeader>
